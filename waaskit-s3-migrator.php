<?php
/**
 * Plugin Name:       Offload Media Importer
 * Plugin URI:        https://github.com/vuckro/aws-s3-wordpress-migrator
 * Description:       Détecte les images hébergées sur un domaine externe (S3, CDN, CMS headless…), les importe dans la Bibliothèque WordPress avec leurs métadonnées, remplace les URLs dans le contenu des articles, et synchronise les ALT édités dans la Bibliothèque vers le HTML des posts.
 * Version:           2.1.0
